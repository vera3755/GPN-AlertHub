...
if __name__=='__main__':
    init_db(); print('='*60); print('GPN AlertHub started'); print(f'Open: http://{HOST}:{PORT}'); print('Close this window to stop'); print('='*60); threading.Timer(1.0,lambda:webbrowser.open(f'http://{HOST}:{PORT}')).start(); ThreadingHTTPServer((HOST,PORT),Handler).serve_forever()
